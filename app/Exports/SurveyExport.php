 ...
 * @package App\Exports
 */
class SurveyExport implements FromCollection, WithHeadings, WithMapping, WithStrictNullComparison, Responsable
{
    /**
     * @var array
     */
    ...
    {
        return Excel::download(new SurveyExport($request->all()), $this->getFileName());
    }
}
