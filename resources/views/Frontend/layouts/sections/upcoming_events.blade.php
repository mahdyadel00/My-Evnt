...
<section class="New-card-event-results-section">
    <div class="New-card-event-results-container">
        <div class="header">
            ...
            <p class="subtitle">Stay tuned for the latest events just around the corner .</p>
        </div>
        ...
        <div class="New-card-event-cards-container">
            <div class="New-card-event-cards-grid">
                ...
                @foreach ($upcoming_events as $event)
                            <div class="New-card-event-card">
                                ...
                                <!--div class="New-card-event-favorite-btn" aria-label="Add to favorites" data-event-id="{{ $event->id }}">
            ...
            <div class="button-card-event">
                    <a href="{{ route('upcoming_events') }}" class="New-card-event-details-btn">
