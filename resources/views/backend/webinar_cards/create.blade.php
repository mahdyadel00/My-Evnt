...
@section('title', 'Add Webinar Card')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Webinar Card</li>
            </ol>
        </nav>

        <form id="add" action="{{ route('admin.webinar_cards.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Add New Webinar Card</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title"
                                            ...
                                            value="{{ old('title', $webinarCard->title ?? '') }}" required>
                                        @error('title')
                                            <span class="text-danger d-block"><i
                                                    class="ti ti-alert-circle ti-xs me-1"></i>{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" class="form-control" id="image" accept="image/*" {{ old('image') ? 'required' : '' }}>
                                        @error('image')
                                            <span class="text-danger d-block"><i
                                                    class="ti ti-alert-circle ti-xs me-1"></i>{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description"
                                            ...
                                            value="{{ old('description', $webinarCard->description ?? '') }}"></textarea>
                                        @error('description')
                                            <span class="text-danger d-block"><i
                                                    class="ti ti-alert-circle ti-xs me-1"></i>{{ $message }}</span>
                                        @enderror
