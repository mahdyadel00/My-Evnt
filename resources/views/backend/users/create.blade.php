                    ...
                    <div class="card mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select name="roles_name[]" id="roles_name" class="form-control select2"
                                            multiple="multiple" required>
                                            <option value="">Select Roles</option>
                                            @foreach ($roles as $role)
                                                <option value="{{ $role }}"
                                                    {{ in_array($role, old('roles_name', [])) ? 'selected' : '' }}>
                                                    {{ $role }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="about" id="about" class="form-control" placeholder="Enter About" required>{{ old('about') }}</textarea>
                                        @error('about')
                                            <span class="text-danger d-block"><i
                                                    class="ti ti-alert-circle ti-xs me-1"></i>{{ $message }}</span>
                                        @enderror
                        ...
                        <div class="card-footer text-center">
                            <button class="btn btn-primary btn-sm pd-x-20" type="submit">
                                <i class="ti ti-device-floppy ti-xs"></i> Add User
                            </button>
                        </div>
                    </div>
                </div>
