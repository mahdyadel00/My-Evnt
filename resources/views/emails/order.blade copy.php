...
<section class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="confirm-box animate__animated animate__fadeInUp">
                <div class="thank-you-message text-center animate__animated animate__bounceIn animate__delay-1s">
                    <h4>Thank You!</h4>
                    <p class="mb-0">Your event registration is confirmed.</p>
                </div>
                <div class="qr-code animate__animated animate__fadeInUp animate__delay-1s">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=SummerMusicFestival2024"
                         alt="Event QR Code">
                    <p>Scan for event details</p>
                </div>
                <ul class="list-group animate__animated animate__fadeInUp animate__delay-1s">
                    <li class="list-group-item"><strong>Event Name:</strong> {{ $event->name }}</li>
                    <li class="list-group-item"><strong>Date:</strong> {{ date('d M Y', strtotime($event->date)) }}</li>
                    <li class="list-group-item"><strong>Time:</strong>
                        {{ date('h:i A', strtotime($event->start_time)) }} -
                        {{ date('h:i A', strtotime($event->end_time)) }}
                    </li>
                    <li class="list-group-item"><strong>Location:</strong> {{ $event->location }}</li>
                    <li class="list-group-item"><strong>Number of Tickets:</strong> 2</li>
                </ul>

                <div class="d-flex justify-content-center mt-3 animate__animated animate__fadeInUp animate__delay-2s">
                    <a href="{{ route('home') }}" class="btn btn-secondary btn-confirm m-2">Return to Home</a>
                    <a href="../Newhome.html" class="btn btn-primary btn-confirm m-2">Confirm</a>
                </div>
            </div>
        </div>
    </div>
