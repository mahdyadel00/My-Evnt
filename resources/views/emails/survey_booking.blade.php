            ...
            <div class="booking-details">
                ...
                <div class="event-info">
                    ...
                    <!-- @if(isset($event->category) && $event->category)
                        <div class="detail-row">
                            <div class="detail-label"><i>🏷️</i> Category :</div>
                            <div class="detail-value">{{ $event->category->name }}</div>
                        </div>
                    @endif -->
                </div>
                ...
                <div class="next-steps">
                    ...
                    <ul>
                        <li>Join our Zoom meeting on February 7th at 7:00 PM using the following link (<a
